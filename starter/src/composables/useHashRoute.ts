 ...
 *
 * Форма ссылки: '#/<маршрут>#<якорь>'. Корневая страница — просто '#<якорь>'.
 * Список маршрутов задаётся один раз при вызове, всё остальное считается корнем.
 */

/** '#/docs#install' при routes ['docs'] → { route: 'docs', anchor: 'install' }. */
