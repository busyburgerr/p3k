 ...
 * сами — поэтому корневой компонент не хранит список id и они не могут
 * разъехаться с разметкой. Скрытое состояние в CSS включается только после
 * старта наблюдателя ([data-reveal-ready] на <html>): без JS или без
 * IntersectionObserver контент остаётся видимым, а не пропадает навсегда.
 */
